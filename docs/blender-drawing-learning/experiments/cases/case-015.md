...
- 对象类型：`MESH` 3、`CAMERA` 1、`ARMATURE` 1、`LIGHT` 1
- 修改器：`SUBSURF` 1、`ARMATURE` 1、`CORRECTIVE_SMOOTH` 1
- Mesh 材质槽数量分布：`4` 1、`1` 1、`6` 1

## 灯光

| 灯光 | 类型 | 能量 | 颜色 |
| --- | --- | ---: | --- |
| `Starlight Sun` | `SUN` | 1.0 | [6.4402, 6.0213, 5.4917] |

## 相机

- `Camera`：35.0mm，PERSP，sensor 36.0
